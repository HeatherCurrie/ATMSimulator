...
namespace ATMSimulator
{
    ...
    {
        int[] playerInput = new int[0];
        private int fullInput;
     ...
     */
        ...
        private void BtnKeyEnter_Click(object sender, EventArgs e)
        {
            ...
            {
                LblInput.Text = "";
                temp = Convert.ToString(String.Join("", playerInput));
                fullInput = Convert.ToInt32(temp);
            }
        }
    }
}
